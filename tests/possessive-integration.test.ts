...
describe('Possessive Integration Test', () => {
  test('Shaw\'s should transliterate to ·𐑖𐑷𐑟', () => {
    const transliterator = new ReadlexiconTransliterator();
    const result = transliterator.transliterate("Shaw's");
  ...
  test('John\'s should transliterate with possessive suffix', () => {
    const transliterator = new ReadlexiconTransliterator();
    const result = transliterator.transliterate("John's");
  ...
  test('Children\'s should transliterate with possessive suffix', () => {
    const transliterator = new ReadlexiconTransliterator();
    const result = transliterator.transliterate("children's");
  ...
  test('it\'s should still work as contraction (not possessive)', () => {
    const transliterator = new ReadlexiconTransliterator();
    const result = transliterator.transliterate("it's");
