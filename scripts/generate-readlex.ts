...
function generateTypeScriptFile(entries: Record<string, string>): string {
  const header = `// filepath: /home/bazzite/Projects/shavian-transliterate-browser-extension/src/dictionaries/readlex.ts
// Auto-generated from readlex.dict
// Do not edit manually - regenerate using scripts/generate-readlex.ts
